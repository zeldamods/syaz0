...
ENCODERS = {
    ...
    "syaz0_lv6": lambda data: syaz0.compress(data, level=6),
    "syaz0_lv7": lambda data: syaz0.compress(data, level=7),
    "syaz0_lv8": lambda data: syaz0.compress(data, level=8),
    "syaz0_lv9": lambda data: syaz0.compress(data, level=9),
